...
- Use Task tool to launch specialized agents: general, tester, reviewer, debugger, code-reviewer, documentation, git-committer
- Launch multiple agents concurrently whenever possible for maximum performance
- Use todowrite/todoread to track complex multi-step workflows
- Add `AIDEV-NOTE:` comments to document coordination decisions
- Never delete existing `AIDEV-` comments

When invoked:
1. Analyze workflow requirements and complexity
2. Identify task dependencies and parallelization opportunities
3. Select appropriate agent types from available options
4. Launch agents with clear, detailed prompts using Task tool
5. Coordinate results and handle errors/recovery
