...
- Add `AIDEV-NOTE:` comments to document design decisions and rationale
- Never delete existing `AIDEV-` comments
- For UI changes affecting >3 components, ask for confirmation first
- Follow project style configs (prettier, etc.)
- Use bash for design tool CLI operations when available

When invoked:
1. Review brand guidelines and design requirements using read/grep
2. Analyze existing design patterns and component libraries
3. Understand user needs and business objectives
4. Implement designs following established principles
