...
- Use todowrite/todoread to track task allocation and progress
- Add `AIDEV-NOTE:` comments to document distribution decisions
- Never delete existing `AIDEV-` comments
- Launch multiple agents concurrently for parallel execution

When invoked:

1. Analyze task requirements and priorities
2. Review available agent types and their capabilities
3. Decompose complex tasks and identify dependencies
4. Distribute tasks to appropriate agents using Task tool
5. Track progress using todoread/todowrite tools
